...
// ============================================
// 🔧 OBTENER ESTADÍSTICAS (VERSIÓN SIMPLE CORREGIDA)
// ============================================
export const obtenerEstadisticas = async (req, res) => {
  try {
    const { pacienteId } = req.params;

    // 🆕 VERSIÓN SIMPLE SIN AGREGACIÓN - Evita errores de mongoose
    ...
    // 🆕 OBTENER ÚLTIMA ACTIVIDAD (opcional)
    ...
    console.log("📊 Estadísticas calculadas:", resultado); // Para debug
