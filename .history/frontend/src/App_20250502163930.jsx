...
import PatientHistoryForm from "./components/PatientHistoryForm"; // Importa el formulario del historial clínico
    ...
    <Router>
      <Routes>
        ...
        <Route
          ...
          element={<PatientHistoryForm />} // Renderiza el componente del historial clínico
        />
      </Routes>
    </Router>
  );
