...
import SubirEstudiosAnalisis from "./components/SubirEstudiosAnalisis"; // <--- AGREGAR ESTA LINEA
  ...
  return (
    <Router>
      <Routes>
        ...
        {/* --- RUTA PARA SOLICITUDES DE PACIENTE --- */}
        <Route
          path='/pacientes/:pacienteId/solicitudes'
          element={<SolicitudesPaciente />}
        />

        {/* --- NUEVA RUTA PARA SUBIR ESTUDIOS DE UNA SOLICITUD --- */}
        <Route
