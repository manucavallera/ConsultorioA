...
import PerfilPaciente from "./components/PerfilPaciente"; // Perfil del paciente
  ...
  return (
    <Router>
      <Routes>
        ...
        {/* Nueva ruta para el Perfil del Paciente */}
        <Route
          path='/perfil/:pacienteId'
          element={<PerfilPaciente />} // Renderiza el componente de perfil del paciente
        />
      </Routes>
    </Router>
  );
