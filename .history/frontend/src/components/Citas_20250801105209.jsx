                ...
                <div className='space-y-3'>
                  {cita.pago.pagos.map((pago) => (
                    ...
                    >
                      ...
                      /* Botones para PAGOS PENDIENTES - Confirmar pagos */}
...
{/* Botones de EDICIÓN/ELIMINACIÓN - Solo para pendientes */}
{pago.estado === "pendiente" && (
  <>
    <button
...
{/* Botones SIEMPRE disponibles - Imprimir/PDF (para TODOS los estados) */}
<div className='relative inline-block'>
  <button
    onClick={() =>
      onImprimirRecibo(cita, pago, "imprimir")
    }
    className='px-6 py-3 bg-purple-500 text-white rounded-lg hover:bg-purple-600 transition-all mr-2'
  >
    🖨️ Imprimir
  </button>
  <button
...
{/* OPCIONAL: Botón de edición para pagos PAGADOS */}
{pago.estado === "pagado" && (
  <button
    onClick={() => iniciarEdicion(pago)}
