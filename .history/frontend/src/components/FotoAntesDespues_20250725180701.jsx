              ...
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
                ...
                <div>
                  <h4 className='text-lg font-semibold text-blue-800 mb-4 flex items-center'>
                    ...
                    Antes del Tratamiento ({comparacion.antes.total})
                  </h4>
                  ...
                  {comparacion.antes.fotos.length === 0 ? (
                    ...
                    <div className='space-y-4'>
                      {comparacion.antes.fotos.map((foto) => (
                        <div
                          key={foto._id}
                          className='bg-blue-50 rounded-xl p-4 hover:shadow-md transition-all duration-200'
                        >
                          <div className='aspect-w-16 aspect-h-12 mb-3'>
                            <img
                              src={foto.archivoUrl}
                              alt={foto.descripcion || "Foto antes"}
                              className='w-full h-48 object-cover rounded-lg cursor-pointer hover:scale-105 transition-transform duration-200'
                              onClick={() =>
                ...
                <div>
                  <h4 className='text-lg font-semibold text-green-800 mb-4 flex items-center'>
                    <span className='mr-2'>📸</span>
                    Después del Tratamiento ({comparacion.despues.total})
                  </h4>
                  ...
                  {comparacion.despues.fotos.length === 0 ? (
                    ...
                    <div className='space-y-4'>
                      {comparacion.despues.fotos.map((foto) => (
                        <div
                          key={foto._id}
                          className='bg-green-50 rounded-xl p-4 hover:shadow-md transition-all duration-200'
                        >
                          <div className='aspect-w-16 aspect-h-12 mb-3'>
                            <img
                              src={foto.archivoUrl}
              ...
              {comparacion.tieneComparacion && (
                <div className='mt-8 bg-gradient-to-r from-green-100 to-blue-100 rounded-xl p-6 text-center'>
                  ...
                  <p className='text-gray-600'>
                    Ya tienes fotos de antes y después del tratamiento. Puedes
                    hacer clic en cualquier imagen para verla en tamaño
                    completo.
                  </p>
                </div>
              )}
