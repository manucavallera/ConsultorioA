...
const PatientInfo = ({ paciente }) => (
  <div className='bg-white/90 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-lg p-4 sm:p-8 mb-6 sm:mb-8 border border-white/20'>
    ...
    {/* ✅ INFORMACIÓN MÉDICA - ACCORDION UNIVERSAL */}
    <details className='mb-8 sm:mb-10 group'>
      <summary className='cursor-pointer bg-red-50 rounded-xl p-3 sm:p-4 hover:bg-red-100 transition-all duration-200 select-none'>
        <div className='flex items-center justify-between'>
          ...
          <span className='text-lg sm:text-xl transition-transform duration-200 group-open:rotate-180'>
            🔽
          </span>
        </div>
      </summary>
    ...
    {/* ✅ INFORMACIÓN ADICIONAL - ACCORDION UNIVERSAL */}
    <details className='mb-8 sm:mb-10 group'>
      <summary className='cursor-pointer bg-purple-50 rounded-xl p-3 sm:p-4 hover:bg-purple-100 transition-all duration-200 select-none'>
        <div className='flex items-center justify-between'>
          <h4 className='text-lg sm:text-xl font-semibold text-gray-800 flex items-center'>
    ...
    {/* ✅ INFORMACIÓN DE REGISTRO - ACCORDION UNIVERSAL */}
    <details className='group'>
      <summary className='cursor-pointer bg-gray-50 rounded-xl p-3 sm:p-4 hover:bg-gray-100 transition-all duration-200 select-none'>
        <div className='flex items-center justify-between'>
          <h4 className='text-lg sm:text-xl font-semibold text-gray-800 flex items-center'>
