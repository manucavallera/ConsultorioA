...
export default function CitasDashboard() {
  ...
  // ✅ FILTROS CORREGIDOS INCLUYENDO PACIENTE:
  const citasFiltradas = citas.filter((cita) => {
    ...
    return cumpleFiltroEstado && cumpleFiltroFecha && cumpleFiltroPaciente;
  });
  ...
  setFiltroFecha("");
  setFiltroPaciente("");
  setFiltroPagos("todos"); // 🆕 AGREGAR ESTA LÍNEA
}}
          ...
          <div className='flex-1'>
            ...
            <div className='mb-4'>
              <div className='flex items-center justify-between mb-3'>
                ...
                >
                  {mostrandoPagos[cita._id] ? "Ocultar" : "Ver"} Pagos
                </button>
              </div>
