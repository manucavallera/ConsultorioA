...
export default function CitasDashboard() {
  ...
  // Auto-crear recordatorios al cargar datos
  useEffect(() => {
    if (citas.length > 0) {
  ...
  try {
    ...
    if (nuevoEstado === "Programada") {
      ...
      if (cita) {
        crearRecordatorioManual(cita); // ✅ CAMBIAR enviarRecordatorioDoctor por crearRecordatorioManual
      }
    }
  } catch (err) {
                ...
                <div className='space-y-6'>
                  {citasFiltradas.map((cita) => (
                    <CitaCard
                      ...
                      onEnviarRecordatorio={crearRecordatorioManual} // ✅ CAMBIAR ESTA LÍNEA
                    />
                  ))}
                </div>
              </div>
      ...
      <div className='p-6'>
        <div className='flex flex-col lg:flex-row lg:items-center justify-between gap-6'>
          ...
          <div className='flex flex-wrap gap-3 lg:flex-col lg:items-end'>
            ...
            <button
              onClick={() => onEnviarRecordatorio(cita)} // Cambiar esta línea
              className='bg-purple-100 text-purple-700 hover:bg-purple-200 px-4 py-3 rounded-xl 
      font-semibold text-sm transition-all duration-200 flex items-center space-x-2 shadow-sm hover:shadow-md'
...
const EstadisticasPagos = () => {
  ...
  return (
    ...
    {/* AQUÍ VA EXACTAMENTE EL CÓDIGO QUE ME ENVIASTE */}
      ...
      <div className='absolute top-16 right-0 w-96 max-h-96 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden'>
        <div className='bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-4'>
          ...
          <p className='text-blue-100 text-sm'>
            {notificaciones.length} recordatorios • {notificacionesNoLeidas} sin
            leer
          </p>
        </div>
