...
export default function PacienteForm({ onPacienteSubmit, pacienteEditando }) {
  ...
  // SOLUCIÓN 1: Usar useCallback para evitar re-creación de función
  ...
  // SOLUCIÓN 2: Memoizar componentes que no cambian
        ...
        (
          <div className={`relative ${className}`}>
            ...
            <input
              ...
              value={formData[name] || ""} // SOLUCIÓN 3: Asegurar que siempre hay un valor
              onChange={handleChange}
              required={required}
              min={min}
              autoComplete='off' // SOLUCIÓN 4: Evitar autocomplete que puede interferir
              className={`w-full ${
        ...
        (
          <div>
            ...
            <textarea
              name={name}
              placeholder={placeholder}
              value={formData[name] || ""} // SOLUCIÓN 3: Asegurar valor
              onChange={handleChange}
              rows={rows}
              autoComplete='off'
