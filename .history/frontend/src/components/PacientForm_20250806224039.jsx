...
export default function PacienteForm({ onPacienteSubmit, pacienteEditando }) {
  // DEBUG: Para detectar si el componente se remonta
  useEffect(() => {
    console.log("🔴 PacienteForm MONTADO");
    return () => console.log("🔴 PacienteForm DESMONTADO");
  }, []);
  ...
  // FIX: Solución definitiva para el problema de tipeo
  const handleChange = (e) => {
    e.persist(); // Asegurar que el evento persista
  ...
  const InputField = ({
    ...
    <div className={`relative ${className}`}>
      ...
      <input
        ...
        value={formData[name] || ""} // FIX: Asegurar string nunca undefined
