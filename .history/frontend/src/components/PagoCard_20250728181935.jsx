...
const PagoCard = ({ pago, onEditar, onEliminar, onWhatsApp }) => {
  ...
  if (!pago || !pago.citaId || !pago.citaId.pacienteId) {
    console.log("Datos de pago incompletos:", pago);
    return (
      <div className='bg-red-50 border border-red-200 rounded-xl p-4 m-4'>
        <p className='text-red-600'>⚠️ Error: Datos de pago incompletos</p>
        <p className='text-red-500 text-sm'>
          Los datos del pago no están completamente cargados
        </p>
      </div>
    );
  }
              ...
              <div className='flex items-center space-x-4'>
                ...
                <div>
                  <h4 className='text-xl font-bold text-gray-900 mb-1'>
                    {paciente.nombre || "N/A"} {paciente.apellido || ""}
                  </h4>
              ...
              <div className='flex items-center justify-between'>
                <div>
                  ...
                  <p className='text-blue-700'>
                    {formatearFecha(cita.fecha)} - {cita.hora || "N/A"}
                  </p>
                  <p className='text-blue-600 text-sm'>
                    {cita.tipoConsulta || "N/A"}
                  </p>
                </div>
                {cita._id && (
                  <button
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mb-4'>
              <div className='flex items-center text-gray-600 bg-gray-50 rounded-xl p-3'>
                ...
                <div>
                  ...
                  <p className='font-semibold'>{pago.metodoPago || "N/A"}</p>
                </div>
              </div>
              ...
              <div className='flex items-center text-gray-600 bg-gray-50 rounded-xl p-3'>
                ...
                <div>
                  ...
                  <p className='font-semibold'>
                    {pago.tipoTratamiento || "Individual"}
                  </p>
                </div>
              </div>
            </div>
