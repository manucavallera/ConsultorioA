...
// Si solicitudId viene por props o URL, no se muestra el selector y se usa directo
const SubirEstudioAnalisis = (props) => {
  // Permite recibir por prop o por URL
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Si tu backend está en otro puerto, usa la URL completa:
