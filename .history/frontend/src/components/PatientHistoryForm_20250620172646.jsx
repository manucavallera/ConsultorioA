        ...
        >
          ...
          <div className='p-6 space-y-4'>
            {[
              ...
              { key: "tipoAlopecia", import React, { useState, useEffect } from "react";
              import { useParams, useLocation, useNavigate } from "react-router-dom";
                      ...
                      <div className="bg-white rounded-2xl shadow-xl p-6 mb-8">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            <div>
                              <h1 className="text-3xl font-bold text-gray-800 flex items-center">
                                <span className="bg-blue-100 text-blue-600 rounded-full p-3 mr-4">📋</span>
                                Historial Clínico
                              </h1>
                              <p className="text-gray-600 mt-1">
                                Gestión completa del historial médico del paciente
              ...
              const PatientInfo = ({ paciente }) => (
                <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
                  <h3 className="text-2xl font-bold text-gray-800 mb-8 flex items-center">
                    <span className="bg-teal-100 text-teal-600 rounded-full p-3 mr-4">👤</span>
                    Información Completa del Paciente
                  </h3>
                  ...
                  <div className="mb-10">
                    <h4 className="text-xl font-semibold text-gray-800 mb-6 flex items-center">
                      <span className="bg-red-100 text-red-600 rounded-full p-3 mr-4">🏥</span>
                      Información Médica
                    </h4>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-gray-50 rounded-xl p-5">
                          <div className="flex items-start">
                            ...
                            <div className="flex-1">
                              <p className="text-sm text-gray-600 font-medium mb-3">Antecedentes de Enfermedad</p>
                        ...
                        <div className="bg-gray-50 rounded-xl p-5">
                          <div className="flex items-start">
                            <span className="text-xl mr-3 mt-1">👨‍👩‍👧‍👦</span>
                            <div className="flex-1">
                              <p className="text-sm text-gray-600 font-medium mb-3">Antecedentes Familiares</p>
                              <p className="text-gray-800 text-base leading-relaxed">
                                {paciente.antecedentesFamiliares || "No especificado"}
                              </p>
                            </div>
                  ...
                  <div className="mb-10">
                    <h4 className="text-xl font-semibold text-gray-800 mb-6 flex items-center">
                      <span className="bg-purple-100 text-purple-600 rounded-full p-3 mr-4">📋</span>
                      Información Adicional
                    </h4>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      {[
                        { key: "horasSueno", label: "Horas de Sueño", icon: "😴", suffix: " horas" },
                        { key: "obraSocial", label: "Obra Social", icon: "🏥" },
                        { key: "tipoShampoo", label: "Tipo de Shampoo", icon: "🧴" },
                      ].map(({ key, label, icon, suffix }) => (
                        <div key={key} className="bg-gray-50 rounded-xl p-5">
                          <div className="flex items-center">
                            ...
                            <div className="flex-1">
                              <p className="text-sm text-gray-600 font-medium mb-1">{label}</p>
                              <p className="text-gray-800 font-semibold text-lg">
                                {paciente[key] ? `${paciente[key]}${suffix || ""}` : "No especificado"}
                              </p>
                            </div>
                          </div>
                        </div>
                  ...
                  <div>
                    <h4 className="text-xl font-semibold text-gray-800 mb-6 flex items-center">
                      <span className="bg-gray-100 text-gray-600 rounded-full p-3 mr-4">📊</span>
                      Información de Registro
                    </h4>
                    <div className="bg-gray-50 rounded-xl p-5">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-gray-800 font-semibold text-lg">
                            {paciente.creadoEn 
                              ? new Date(paciente.creadoEn).toLocaleDateString() + " a las " + 
                                new Date(paciente.creadoEn).toLocaleTimeString()
                              : "No disponible"
                            }
                          </p>
              ...
              const HistoryCards = ({ historial, onEdit, onDelete, paciente, navigate }) => (
                <div className="p-6">
                  <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                    {historial.map((entry, index) => (
                      <div key={entry._id} className="bg-gradient-to-br from-white to-gray-50 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden">
                        {/* Card Header */}
                        <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white p-4">
                          <div className="flex items-center justify-between">
                            <h4 className="font-bold text-lg">Registro #{index + 1}</h4>
                        ...
                        <div className="p-6 space-y-4">
                          {[
                            { key: "tipoCueroCabelludo", label: "Cuero Cabelludo", icon: "🧴" },
                            { key: "frecuenciaLavadoCapilar", label: "Frecuencia Lavado", icon: "🚿" },
                            { key: "tricoscopiaDigital", label: "Tricoscopia", icon: "🔬" },
