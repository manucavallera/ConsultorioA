    ...
    {/* Error Alert */}
        ...
        <div className='bg-white/80 backdrop-blur-lg rounded-2xl sm:rounded-3xl shadow-xl border border-white/20 p-4 sm:p-8 mb-6 sm:mb-8'>
          <div className='flex items-center mb-4 sm:mb-6'>
            ...
            <h3 className='text-xl sm:text-2xl font-bold text-gray-900'>Filtros</h3>
          </div>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6'>
            ...
            <div className='flex items-end'>
              ...
              >
                🔄 <span className='hidden sm:inline'>Limpiar filtros</span><span className='sm:hidden'>Limpiar</span>
              </button>
            </div>
          </div>
        </div>
...
const CitaCard = ({
  ...
  return (
    <div className='bg-white rounded-xl sm:rounded-2xl border border-gray-200 hover:border-gray-300 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 overflow-hidden'>
      <div className={`h-1 sm:h-1.5 ${obtenerColorTipo(cita.tipoConsulta)}`}></div>
            ...
            <div className='flex-1'>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-4'>
                {[
                  ...
                  >
                    <span className='mr-2 sm:mr-3 text-base sm:text-lg'>{item.icono}</span>
                    <div className='min-w-0 flex-1'>
                      <p className='text-xs font-medium text-gray-500 uppercase tracking-wide'>
                        {item.titulo}
                      </p>
                      <p className='font-semibold text-sm sm:text-base truncate'>{item.valor}</p>
                    </div>
                  </div>
                ))}
              </div>
                  ...
                  <div className='bg-gray-50 rounded-lg sm:rounded-xl p-3 mb-3'>
                    <div className='grid grid-cols-3 gap-2 sm:gap-4 text-center'>
                      <div>
                        ...
                        <p className='font-semibold text-sm sm:text-base'>{cita.pago.pagos.length}</p>
                      </div>
                      <div>
                    ...
                    {cita.pago.pagos.map((pago) => (
                      ...
                      >
                        <div className='flex flex-col sm:flex-row sm:items-center justify-between mb-3 gap-2'>
                          ...
                          <span className='font-bold text-base sm:text-lg'>${pago.monto}</span>
                        </div>
            ...
            <div className='flex flex-row sm:flex-col gap-2 sm:gap-3 justify-start sm:items-end overflow-x-auto sm:overflow-x-visible'>
              ...
              <button
                ...
                className='bg-blue-100 text-blue-700 hover:bg-blue-200 px-3 sm:px-4 py-2 sm:py-3 rounded-lg sm:rounded-xl 
                  font-semibold text-xs sm:text-sm transition-all duration-200 flex items-center space-x-2 shadow-sm hover:shadow-md whitespace-nowrap flex-shrink