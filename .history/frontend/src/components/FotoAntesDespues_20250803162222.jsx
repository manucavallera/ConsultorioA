        ...
        {comparacion && (
          <div className='bg-white rounded-2xl shadow-lg overflow-hidden'>
            ...
            <div className='p-6'>
              ...
              {comparacion.tieneComparacion &&
                ...
                comparacion.despues.fotos.length > 0 && (
                  <div className='mb-8'>
                    ...
                    <div className='bg-gradient-to-r from-blue-50 via-purple-50 to-green-50 rounded-2xl p-6 mb-6'>
                      ...
                      <div className='relative bg-black rounded-2xl overflow-hidden shadow-2xl max-w-4xl mx-auto'>
                        ...
                        <div className='flex'>
                          ...
                          {/* LÍNEA DIVISORIA */}
                          <div className='w-1 bg-white relative z-10 shadow-xl'>
                            <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
                              <div className='bg-white text-gray-800 rounded-full w-8 h-8 flex items-center justify-center shadow-lg text-sm font-bold'>
                                VS
                              </div>
                            </div>
                          </div>

                          {/* IMAGEN DESPUÉS - Mitad derecha */}
                          <div className='w-1/2 relative group cursor-pointer'>
                            <img
                        ...
                        {/* Título flotante en el centro superior */}
                        <div className='absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
                          <div className='bg-white text-gray-800 px-6 py-2 rounded-full shadow-xl border-4 border-gray-100'>
                    ...
                    // 🎨 ALTERNATIVA CON SLIDER (más interactiva): // Si
                    quieres algo aún más profesional, aquí tienes una versión
                    con slider:
                    ...
                    <div className='bg-gradient-to-r from-blue-50 via-purple-50 to-green-50 rounded-2xl p-6 mb-6'>
                      <div className='relative bg-black rounded-2xl overflow-hidden shadow-2xl max-w-4xl mx-auto'>
                        ...
                        <div className='relative'>
                          ...
                          {/* Imagen superpuesta (ANTES) con clip-path */}
                          <div
                          ...
                          <div className='absolute top-0 left-1/2 w-1 h-full bg-white shadow-xl transform -translate-x-1/2'>
                            <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
                              <div className='bg-white text-gray-800 rounded-full w-8 h-8 flex items-center justify-center shadow-lg text-xs font-bold'>
                                ⟷
                              </div>
                            </div>
                          </div>
                      ...
                      <div className='mt-4 text-center'>
                        <p className='text-gray-600 text-sm'>
                          Vista comparativa unificada - Antes (izquierda) vs
                          Después (derecha)
                        </p>
                      </div>
                    </div>
              ...
              {/* 🆕 TODAS LAS FOdiv>TOS ORGANIZADAS */}
