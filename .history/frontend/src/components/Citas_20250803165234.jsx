...
export default function CitasDashboard() {
  ...
  // 🆕 AGREGAR ESTAS FUNCIONES AQUÍ (después de todos los useState, antes del useEffect):
  ...
  const enviarRecordatorioDoctor = (cita) => {
    ...
    // Crear mensaje de recordatorio para el doctor
...
⏰ *Recordatorio configurado*`;
  ...
  const enviarRecordatorioDoctor = (cita) => {
    ...
    // 📱 NÚMERO DEL DOCTOR (CAMBIAR POR TU NÚMERO)
    const telefonoDoctor = "+5491123456789"; // 🔧 REEMPLAZAR CON TU NÚMERO
