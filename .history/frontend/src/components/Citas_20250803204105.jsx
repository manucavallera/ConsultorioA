              ...
              notificaciones.map((notif) => (
                ...
                >
                  <div className='flex items-start space-x-3'>
                    <div
                      className={`${notif.color} rounded-full p-2 text-white`}
                    >
...
// Componente Modal de Gestión de Pagos
                ...
                <div className='space-y-6'>
                  ...
                  <div className='flex gap-4'>
                    ...
                    <button
                      ...
                      // Continuación del ModalGestionPagos desde donde se cortó:
...
// Componente EstadisticasPagos (que estaba referenciado pero no definido)
// Reemplaza el componente EstadisticasPagos existente con esta versión:
  ...
  return (
    <div className='bg-white/80 backdrop-blur-lg rounded-3xl shadow-xl border border-white/20 p-8 mb-8'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
        <div className='bg-gradient-to-br from-green-500 to-green-600 text-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-1'>
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-green-200 text-xs mt-1'>Total pagados</p>
            </div>
            <div className='bg-white/20 rounded-xl p-3'>
              <span className='text-2xl'>✅</span>
            </div>
        ...
        <div className='bg-gradient-to-br from-orange-500 to-orange-600 text-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-1'>
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-orange-200 text-xs mt-1'>Por cobrar</p>
            </div>
            <div className='bg-white/20 rounded-xl p-3'>
              <span className='text-2xl'>⏳</span>
            </div>
        ...
        <div className='bg-gradient-to-br from-red-500 to-red-600 text-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-1'>
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-red-200 text-xs mt-1'>Requieren atención</p>
            </div>
            <div className='bg-white/20 rounded-xl p-3'>
        ...
        <div className='bg-gradient-to-br from-blue-500 to-blue-600 text-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-1'>
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-blue-200 text-xs mt-1'>Total facturado</p>
            </div>
            <div className='bg-white/20 rounded-xl p-3'>
              <span className='text-2xl'>💎</span>
            </div>
        ...
        <div className='bg-gradient-to-br from-purple-500 to-purple-600 text-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-1'>
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-purple-200 text-xs mt-1'>Por cobrar</p>
            </div>
            <div className='bg-white/20 rounded-xl p-3'>
              <span className='text-2xl'>💸</span>
            </div>
        ...
        <div className='bg-gradient-to-br from-gray-500 to-gray-600 text-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-1'>
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-gray-200 text-xs mt-1'>Todos los pagos</p>
            </div>
            <div className='bg-white/20 rounded-xl p-3'>
              <span className='text-2xl'>📊</span>
            </div>
