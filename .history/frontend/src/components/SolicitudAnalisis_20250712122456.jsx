            ...
            <div className='flex items-center'>
              ...
              <div>
                ...
                <p className='text-gray-600 mt-1'>
                  Gestión completa de análisis clínicos y resultados
                </p>
              </div>
            </div>
              ...
              <div className='p-6'>
                ...
                <div className='flex justify-end space-x-4 mt-6'>
                  ...
                  <button
                    ...
                    className='px-8 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white 
                    ...
                    >
                      <div className='flex flex-col lg:flex-row lg:items-center justify-between'>
                        <div className='flex-1'>
                          ...
                          {/* Análisis solicitados preview con valores */}
                          <div className='mt-3'>
