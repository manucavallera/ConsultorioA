...
export default function CitasDashboard() {
  ...
  const enviarRecordatorioDoctor = (cita) => {
    ...
    // Usar el número configurado
    const telefonoDoctor = numeroDoctor;

    // 🔧 CORREGIR: El mensaje necesita saltos de línea (\n)
    const fechaFormateada = formatearFecha(cita.fecha);
    const mensaje = `🩺 *CITA PROGRAMADA* 📅
...
📞 *Contacto paciente:* ${paciente.telefono || "Sin teléfono"}
🆔 *DNI:* ${paciente.dni}
...
⏰ *Recordatorio configurado*`;
    ...
    // Crear URL de WhatsApp para tu número
    ...
    try {
      ...
      setMensaje(
        `📱 Recordatorio enviado - Cita de ${paciente.nombre} programada`
      );
      setTimeout(() => setMensaje(""), 5000);
    } catch (error) {
      console.error("Error al abrir WhatsApp:", error);
      setError("Error al abrir recordatorio de WhatsApp");
    }
  };
      ...
      <div className='p-6'>
        <div className='flex flex-col lg:flex-row lg:items-center justify-between gap-6'>
          ...
          <div className='flex flex-wrap gap-3 lg:flex-col lg:items-end'>
            ...
            <button
              onClick={() => enviarRecordatorioDoctor(cita)}
