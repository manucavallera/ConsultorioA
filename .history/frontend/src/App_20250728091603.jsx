...
import PagosDashboard from "./components/PagosDashboard"; // ✅ NUEVO IMPORT
  ...
  return (
    <Router>
      <Routes>
        ...
        {/* ✅ RUTA PARA PAGOS DE UN PACIENTE ESPECÍFICO */}
        <Route
          path='/pacientes/:pacienteId/pagos'
          element={<PagosDashboard />}
        />
        {/* ✅ RUTA PARA PAGO DESDE UNA CITA ESPECÍFICA */}
