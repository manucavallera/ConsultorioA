...
import {
  // ✅ Tus funciones originales (las que ya tienes)
  subirEstudio,
...
// Ej: GET /estudios/fotos/paciente/123?tipo=antes&zona=rostro
router.get("/fotos/paciente/:pacienteId", obtenerFotosPaciente);

// Obtener comparación antes/después de un paciente
// Ej: GET /estudios/fotos/comparacion/123?zona=rostro&angulo=frontal
